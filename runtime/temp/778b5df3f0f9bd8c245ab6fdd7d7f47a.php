<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"../public/templete/AdminThemes/auth_group\index.html";i:1494487413;s:56:"../public/templete/AdminThemes/layout\common_layout.html";i:1500275822;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="layui-tab-item layui-show">
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo url('admin/auth_group/auth',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-mini">授权</a>
                            <a href="<?php echo url('admin/auth_group/edit',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-normal layui-btn-mini">编辑</a>
                            <a href="<?php echo url('admin/auth_group/delete',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-danger layui-btn-mini ajax-delete">删除</a>
                        </td>
                    </tr>
