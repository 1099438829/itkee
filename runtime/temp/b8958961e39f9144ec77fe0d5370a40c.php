<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"../public/templete/AdminThemes/login\index.html";i:1499936471;s:55:"../public/templete/AdminThemes/layout\login_layout.html";i:1499936471;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="login-layout">
    ...
    <form method="post" class="layui-form" id="form_login" action="<?php echo url('admin/login/login'); ?>">
        ...
        <div class="submit">
            ...
            <div class="code">
                <div class="arrow"></div>
                <div class="code-img">
                    <img  src="<?php echo captcha_src(); ?>" alt="点击更换" title="点击更换" onclick="this.src='<?php echo captcha_src(); ?>?time='+Math.random()" class="captcha" name="codeimage" id="codeimage" border="0"/>
                </div>
                <a href="JavaScript:void(0);" id="hide" class="close" title="关闭"><i></i></a><a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='<?php echo captcha_src(); ?>';" class="change" title="看不清,点击更换验证码"><i></i></a>
            </div>
