<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"../public/templete/AdminThemes/nav\add.html";i:1496842778;s:56:"../public/templete/AdminThemes/layout\common_layout.html";i:1500275822;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="layui-tab layui-tab-brief">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <form class="layui-form form-container" action="<?php echo url('admin/nav/save'); ?>" method="post">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="nav_cid" required lay-verify="required">
                                ...
                                <option value="<?php echo $key; ?>" <?php if($key==$nav_cid): ?> selected="selected"<?php endif; ?>><?php echo $vv; ?></option>
